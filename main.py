...
<form method="post">
    <table>
        <tr>
            <td>
            <label>Username: <input type="text" name="username" value="{input_username}"/></label>
            </td>
            <td>
        ...
        <tr>
            <td>
            <label>Email (optional): <input type="text" name="email" value="{input_email}"/></label>
                <td>
...
#string substitution
        ...
        password_message= user_password, password_match_message= match_password,
        email_message= user_email, input_username= "", input_email= ""))
